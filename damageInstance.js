...
class melee{
    constructor(source, damage, width, height, knockback = 5, span = 90, name = 'sword', clickFunc = null, runFunc = null, runFuncCD = 50, tier = 0, increase = null, sprite = document.getElementById('sword')){
